...
offckb deploy --network devnet --target <contract-binary-path> --output /home/linnette/ckbuilders/experiments/capsule-type-script/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output /home/linnette/ckbuilders/experiments/capsule-type-script/deployment
```
